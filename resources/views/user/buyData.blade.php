   ...
   <div class="container-lg">
        <div class="row justify-content-center">
            <div class="col-lg-6 text-center">
                ...
                @else
                    <form action="{{ route('user.buyData') }}" method="post" onsubmit="return validateForm()" class="p-4">
                    @csrf
                        <div class="mb-4">
                        ...
                        <button type="submit" name="buyData" class="btn w-100 py-3 text-white fw-bold rounded-pill" style="background-color: #0a0a7a;">
                            Buy Now
                        </button>
                    </form>
                @endif
